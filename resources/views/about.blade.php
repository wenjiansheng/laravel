...
<head>
    ...
    <article>
        ...
        <div class="about">
            <h2>Just about me</h2>
            <ul>
                <p>清欢渡，女，一个80后草根女站长！09年入行，从业已经有三四年。从搬砖一样的生活方式换成了现在有“单”而居的日子。当然这个单不是单身的单，跟我的职业相比，爱情脱单并不是问题！虽然极尽苛刻的征婚条件但也远不及客户千奇百怪的要求。告别了朝九晚五，躲过了风吹日晒，虽然不再有阶梯式的工资，但是偶尔可以给自己放放假，挽着老公，一起轻装旅行。</p>
    ...
    <aside>
        <div class="avatar"><a href="about.html"><span>关于清欢渡</span></a></div>
        ...
        <div class="about_c">
            ...
            <p><a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&amp;email=HHh9cn95b3F1cHVye1xtbTJ-c3E" ><img src="http://rescdn.qqmail.com/zh_CN/htmledition/../images/function/qm_open/ico_mailme_22.png" alt="清欢渡个人博客网站"></a></p>
            <p>
